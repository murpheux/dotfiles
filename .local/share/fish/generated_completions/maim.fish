# maim
# Autogenerated from man page /usr/lib/jvm/default/man/man1/maim.1.gz
...
complete -c maim -s i -l window -d 'Sets the desired window to capture, defaults to the root window'
